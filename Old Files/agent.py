...
FIXED: Notes vs Nodes confusion + Note counting bug
"""
...
class VoiceAgent:
    ...
    # ------------------------------------------------------------------
    # Notes (FIXED - better matching to avoid "nodes" confusion)
    ...
    # ------------------------------------------------------------------
    # Command processing (FIXED - better pattern matching for notes)
    def process_command(self, text):
        ...
        # Tasks - MUST come before notes to avoid confusion
        ...
        if re.search(r'show\s+tasks|list\s+tasks|display\s+tasks', text):
            self.show_tasks()
            return
        ...
        # Notes - FIXED: Better pattern matching to avoid "nodes" confusion
        ...
        if re.search(r'show\s+notes|list\s+notes|display\s+notes', text):
            self.show_notes()
            return
